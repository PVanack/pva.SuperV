...
namespace pva.SuperV.ApiTests
{
    public class ClassEndpointsTests
    {
        ...
        public async Task GivenExistingClassesInProject_WhenSearchingProjectClasses_ThenClassesAreReturned()
        {
            ...
            // WHEN
            var response = await client.PostAsJsonAsync("/classes/Project1/search", search, TestContext.Current.CancellationToken);

            // THEN
            response.StatusCode.ShouldBe(System.Net.HttpStatusCode.OK);
            PagedSearchResult<ClassModel>? projectClasses = await response.Content.ReadFromJsonAsync<PagedSearchResult<ClassModel>>(TestContext.Current.CancellationToken);
        ...
        public async Task GivenExistingClassesInProject_WhenGettingProjectClasses_ThenClassesAreReturned()
        {
            ...
            // THEN
            response.StatusCode.ShouldBe(System.Net.HttpStatusCode.OK);
            ClassModel[]? projectClasses = await response.Content.ReadFromJsonAsync<ClassModel[]>(TestContext.Current.CancellationToken);
        ...
        public async Task GivenExistingClassesInProject_WhenGettingProjectClass_ThenClassIsReturned()
        {
            ...
            // THEN
            response.StatusCode.ShouldBe(System.Net.HttpStatusCode.OK);
            ClassModel? retrievedClass = await response.Content.ReadFromJsonAsync<ClassModel>(TestContext.Current.CancellationToken);
        ...
        public async Task GivenWipProject_WhenCreatingProjectClass_ThenClassIsCreated()
        {
            ...
            // WHEN
            var response = await client.PostAsJsonAsync("/classes/Project1", expectedClass, TestContext.Current.CancellationToken);

            // THEN
            response.StatusCode.ShouldBe(System.Net.HttpStatusCode.Created);
            ClassModel? createdClass = await response.Content.ReadFromJsonAsync<ClassModel>(TestContext.Current.CancellationToken);
        ...
        public async Task GivenUnknownProjectProject_WhenCreatingProjectClass_ThenNotFoundIsReturned()
        {
            ...
            // WHEN
            var response = await client.PostAsJsonAsync("/classes/UnknownProject", expectedClass, TestContext.Current.CancellationToken);
        ...
        public async Task GivenNonWipProject_WhenCreatingProjectClass_ThenBadRequestIsReturned()
        {
            ...
            // WHEN
            var response = await client.PostAsJsonAsync("/classes/RunnableProject", expectedClass, TestContext.Current.CancellationToken);
        ...
        public async Task GivenExistingClassInWipProject_WhenUpdatingProjectClass_ThenClassIsUpdated()
        {
            ...
            // WHEN
            var response = await client.PutAsJsonAsync($"/classes/Project1/{expectedClass.Name}", expectedClass, TestContext.Current.CancellationToken);
        ...
        public async Task GivenUnknownProjectProject_WhenUpdatingProjectClass_ThenNotFoundIsReturned()
        {
            ...
            // WHEN
            var response = await client.PutAsJsonAsync($"/classes/UnknownProject/{expectedClass.Name}", expectedClass, TestContext.Current.CancellationToken);
        ...
        public async Task GivenNonWipProject_WhenUpdatingProjectClass_ThenBadRequestIsReturned()
        {
            ...
            // WHEN
            var response = await client.PutAsJsonAsync($"/classes/RunnableProject/{expectedClass.Name}", expectedClass, TestContext.Current.CancellationToken);
